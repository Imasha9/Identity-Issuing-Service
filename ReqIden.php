...
<form method="post" action="ReqIden.php">
  ...
  $sql = "SELECT * FROM request_identity order by ID desc limit 1";
  $result = $conn->query($sql);

  if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc())
    // Display the details
   { echo "<h2>Request Identity Details:</h2>";
    echo "<br>District: " . $row['District'] . "<br>";
    echo "D.S. Division: " . $row['DS_Division'] . "<br>";
    echo "Number Of Division: " . $row['number_of_division'] . "<br>";
    echo "Type Of Identity Card: " . $row['id_type'] . "<br>";
    echo "Name with initials: " . $row['name'] . "<br>";
    echo "Gender: " . $row['gender'] . "<br>";
    echo "Civil Status: " . $row['civil'] . "<br>";
    echo "Profession/Occupation: " . $row['profession'] . "<br>";
    echo "Date Of Birth: " . $row['dob'] . "<br>";
    echo "Birth Certificate No: " . $row['birth_certificate_no'] . "<br>";
    echo "Place Of Birth: " . $row['birth_place'] . "<br>";
    echo "City: " . $row['city'] . "<br>";
    echo "Division: " . $row['division'] . "<br>";
    echo "Country Of Birth: " . $row['country'] . "<br>";
    echo "Name/Number of the house: " . $row['number_of_house'] . "<br>";
    echo "Road/Street: " . $row['road'] . "<br>";
    echo "Village/City: " . $row['village'] . "<br>";
    echo "Postal Code: " . $row['postal_code'] . "<br>";
    echo "Purpose for application: " . $row['purpose'] . "<br>";
    echo "Last ID Card number: " . $row['last_id'] . "<br>";
    echo "Date of the issue of the Identity Card: " . $row['issue_date'] . "<br>";
    echo "Telephone no: " . $row['telephone'] . "<br>";
    echo "Residence mobile: " . $row['mobile'] . "<br>";
